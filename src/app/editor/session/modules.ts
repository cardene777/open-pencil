...
export function createEditorStoreModules(
  ...
  return {
    ...
    flushRemotePageAutosaveNow: documentIO.flushRemotePageAutosaveNow,
    syncRemotePageAutosaveBaseline: documentIO.syncRemotePageAutosaveBaseline,
    resetRemotePageAutosaveState: documentIO.resetRemotePageAutosaveState,
