      ...
      <template v-else-if="payload">
        <section class="rounded-[24px] border border-border bg-panel/75 p-5">
          <div class="flex items-center justify-between">
            ...
            <span
              class="rounded-full border border-border bg-canvas/60 px-2 py-1 text-[11px] uppercase tracking-[0.16em] text-muted"
            >
              {{ payload.team.role }}
            </span>
          </div>
          ...
          <ul data-test-id="team-detail-member-list" class="mt-4 space-y-3">
            ...
            >
              ...
              <div class="flex items-center gap-2">
                <span
                  class="rounded-full border border-border bg-panel px-2 py-1 text-[11px] uppercase tracking-[0.14em] text-muted"
                >
                  {{ member.role }}
                </span>
                <button
