...
export const landingMessages = i18n('landing', {
  headTitle: 'Inkly — Design tool for ambitious teams',
  navProduct: 'Product',
  navPricing: 'Pricing',
  navDocs: 'Docs',
  navChangelog: 'Changelog',
  navOpenEditor: 'Open editor',
  navOpenDashboard: 'Dashboard',
  heroEyebrow: 'New · Inkly v2',
  heroTitleLine1: 'Design tools should',
  heroTitleHighlight: 'feel weightless.',
  heroTitleLine2: 'Inkly delivers.',
  heroSubtitle:
    'A canvas-native, multiplayer design surface built on WebGL and Skia. Vectors that never blur, components that propagate at 120 fps, and a multiplayer model that survives a flaky train wifi.',
  heroCtaPrimary: 'Open the editor',
  heroCtaSecondary: 'See live boards',
  heroBadgeWebgl: 'WebGL · Skia',
  heroBadgeRealtime: 'Realtime CRDT',
  heroBadgeOpen: 'OSS · MIT',
  featuresEyebrow: 'Why Inkly',
  featuresHeading: 'Built for designers who ship',
  featuresIntro:
    'No more proprietary canvases that lock your team in. Inkly is open, fast, and made for serious design work.',
  feature1Title: 'Real Skia rendering',
  feature1Body:
    'Powered by CanvasKit on WebGL. Strokes, gradients and effects render the same in browser, desktop and export — pixel for pixel.',
  feature2Title: 'Multiplayer that stays alive',
  feature2Body:
    'P2P via WebRTC + Yjs CRDT. Boards survive offline edits, late joiners, and unstable hotel wifi. Your cursors never lie.',
  feature3Title: 'Components that scale',
  feature3Body:
    'Component sets, instances and overrides propagate in O(n) without re-render storms. Design systems stay coherent across thousands of nodes.',
  feature4Title: 'Open scene graph',
  feature4Body:
    'Inspect, query and mutate the scene graph from CLI, MCP or your own scripts. No closed file format, no vendor lock-in.',
  feature5Title: 'AI-native, by choice',
  feature5Body:
    'Bring your own model. Inkly exposes tools to MCP-aware agents so they can draft, refactor and lint your designs without taking over.',
  feature6Title: 'Light and dark, native',
  feature6Body:
    'Every surface, every glyph, every shadow has a dedicated token in both themes. Switch instantly without seeing a single flash of unstyled chrome.',
  metricsEyebrow: 'Numbers',
  metricsHeading: 'Performance budget, not aspiration',
  metric1Value: '120fps',
  metric1Label: 'canvas paint cap',
  metric2Value: '<8ms',
  metric2Label: 'select-to-paint latency',
  metric3Value: '∞',
  metric3Label: 'nodes per board',
  metric4Value: 'P2P',
  metric4Label: 'no relay needed',
  workflowEyebrow: 'How it flows',
  workflowHeading: 'From blank canvas to shipped',
  step1Tag: '01',
  step1Title: 'Sketch',
  step1Body:
    'Open Inkly, drop a frame, start drawing. Components, auto-layout and snapping work the way you already expect.',
  step2Tag: '02',
  step2Title: 'Collaborate',
  step2Body:
    'Share a room link, paste it on Slack. Anyone with the URL is in. P2P cursors, CRDT history, zero latency.',
  step3Tag: '03',
  step3Title: 'Ship',
  step3Body:
    'Export as SVG, PNG, JSX or a raw scene graph. Inkly speaks every format your codebase already speaks.',
  ctaEyebrow: 'Get started',
  ctaHeading: 'Your next design lives on Inkly',
  ctaBody:
    'No card, no account required. Open the editor, draw, share. Sign in only when you want your boards to follow you across devices.',
  ctaPrimary: 'Launch the editor',
  ctaSecondary: 'Browse my boards',
  footerTagline: 'A canvas-native design tool for ambitious teams.',
  footerProduct: 'Product',
  footerCompany: 'Company',
  footerResources: 'Resources',
  footerLegal: 'Legal',
  footerCopyright: params('© {year} Inkly — MIT licensed'),
